                    ...
                    <div class="container-fluid">
                        ...
                        <h3 class="text-dark mb-0">My posts</h3><a class="btn btn-primary btn-sm d-none d-sm-inline-block" role="button" href="#"><i class="fas fa-download fa-sm text-white-50"></i>&nbsp;Generate Report</a>
                            ...
                            <div class="col-md-4" style="margin-top: 30px;">
                                <div class="card"><img class="card-img-top w-100 d-block" src="../assets/img/loft.jpg">
                                    <div class="card-body" style="padding-bottom: 30px;box-shadow: 0px 0px 6px var(--bs-gray-500);">
                                        <h4 class="card-title text-dark" style="padding-top: 20px;padding-left: 20px;font-weight: bold;">Easy Ways to Use Alternatives to plastic</h4>
                                        <p class="card-text text-dark" style="padding-left: 20px;padding-right: 20px;font-size: 13px;padding-bottom: 0px;">Nullam id dolor id nibh ultricies vehicula ut id elit. Cras justo odio, dapibus ac facilisis in, egestas eget quam. Donec id elit non mi porta gravida at eget metus.</p>
                                        <small style="background: var(--bs-blue);color: var(--bs-white);padding: 5px;margin-left: 20px;margin-bottom: 30px;margin-top: -3px;">Fashion</small>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4" style="margin-top: 30px;">
                                <div class="card"><img class="card-img-top w-100 d-block" src="../assets/img/building.jpg">
                                    <div class="card-body" style="padding-bottom: 30px;box-shadow: 0px 0px 5px 0px var(--bs-gray-500);">
                                        <h4 class="card-title text-dark" style="padding-top: 20px;padding-left: 20px;font-weight: bold;">Easy Ways to Use Alternatives to plastic</h4>
                                        <p class="card-text" style="font-size: 13px;padding-right: 20px;padding-left: 20px;color: var(--bs-gray-800);">Nullam id dolor id nibh ultricies vehicula ut id elit. Cras justo odio, dapibus ac facilisis in, egestas eget quam. Donec id elit non mi porta gravida at eget metus.</p>
                                        <small style="background: var(--bs-blue);color: var(--bs-white);padding: 5px;margin-left: 20px;margin-bottom: 30px;margin-top: -3px;">Technology</small>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4" style="margin-top: 30px;">
                                <div class="card"><img class="card-img-top w-100 d-block" src="../assets/img/minibus.jpeg">
